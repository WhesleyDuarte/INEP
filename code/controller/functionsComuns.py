from INEP.code.view.matlocalizacao import Urbana, Rural
from INEP.code.view.sexoEtnia import Feminina, Masculino
from INEP.code.view.tempoIntegralParcial import TempoParcial, TempoIntegral
